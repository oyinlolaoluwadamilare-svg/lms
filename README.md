...
3. [`docs/07-build-backlog.md`](./docs/07-build-backlog.md) — the dependency-ordered milestone
   backlog (M0–M9). Current milestone: **M0 — Foundation**, task M0.1 (this scaffold).
...
typecheck, lint and the wired test suites. No product tables, routes or features exist yet — see
`docs/07-build-backlog.md` for what M0.2 onward brings.
